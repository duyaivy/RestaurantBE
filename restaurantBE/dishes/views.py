...
class DishListCreateAPIView(ListCreateAPIView):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            cache_key = f"dish_list_{params_hash}"
            cached_data = cache.get(cache_key)
            if cached_data:
                return apiSuccess(cached_data, msg=_("get_all_dish_success"))
            ...
            if page is not None:
                ...
                cache.set(cache_key, resData, timeout=3600)
...
class DishRetrieveUpdateDestroyAPIView(RetrieveUpdateDestroyAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            cache_key = f"dish_detail_{dish_id}"
            cached_data = cache.get(cache_key)
            if cached_data:
                return apiSuccess(cached_data, msg=_("get_dish_success"))
